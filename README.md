...
Calendario mensual de pagos conectado a Supabase: vista Calendario/Lista, KPIs del mes (Ingresos / Pagos / Pagado / Pendiente / Vencido), próximos vencimientos y detalle de pago con acción "Marcar pagado".
